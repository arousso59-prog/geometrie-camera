...
TargetObservation::TargetObservation()
    : valid(false),
      ...
      subpixel_left_line(),
      pattern_refined(false),
      pattern_feature_count(0),
      pattern_inlier_count(0),
      pattern_rms_px(0.0f),
      pattern_max_residual_px(0.0f),
...
GeometryMeasurement::GeometryMeasurement()
    : valid(false),
      ...
      pose_v3_yaw_deg(0.0f),
      pose_v3_pitch_deg(0.0f),
      pose_v3_roll_deg(0.0f),
      pose_v3_pattern_rms_px(0.0f),
