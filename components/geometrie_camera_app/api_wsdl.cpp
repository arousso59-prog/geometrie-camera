...
void ApiWsdlHandler::handleRequest(AsyncWebServerRequest *request) {
  ...
  xml += "<api name=\"geometrie-camera\" version=\"30\">\n";
  ...
  xml += "    <item>V30 conserve camera V25, distance V6.1-robust5 et Pose V3; le mode continu pipeline la frame suivante pendant decode/detection et conserve une purge obligatoire apres changement de viewport.</item>\n";
