...
void ApiWsdlHandler::handleRequest(AsyncWebServerRequest *request) {
  ...
  xml += "<api name=\"geometrie-camera\" version=\"32\">\n";
  ...
  xml += "    <item>V32 conserve camera V25, distance V6.1-robust5 et capture pipelinee; Pose V4 ajuste directement la rotation sur les transitions subpixel du motif 7x7, avec V3/V2/V1 conserves en diagnostic.</item>\n";
