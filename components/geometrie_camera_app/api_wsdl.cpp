...
void ApiWsdlHandler::handleRequest(AsyncWebServerRequest *request) {
  ...
  xml += "<api name=\"geometrie-camera\" version=\"38\" style=\"REST-over-HTTP\">\n";
  ...
  xml += "    <item>Calibration optique automatique : apres verrouillage PRECISE, le frame valide courant sert de baseline minimale. 5 essais AE automatiques puis 11 essais manuels exposition/gain (16 prises maximum) optimisent nettete, qualite de detection, RMS subpixel et contraste noir/blanc P10-P90. Les images trop sombres ou sans contraste sont rejetees. Le meilleur AE/exposition/gain est verrouille avec AEC/AGC OFF et conserve pour les mesures suivantes.</item>\n";
