...
void ApiWsdlHandler::handleRequest(AsyncWebServerRequest *request) {
  ...
  xml += "<api name=\"geometrie-camera\" version=\"41\" style=\"REST-over-HTTP\">\n";
  ...
  xml += "    <item>GeometryMeasurementEngine V6 fusionne z_from_width_mm et z_from_height_mm selon l incertitude issue des separations locales robustes ; pose_z_mm reste un controle independant issu de l homographie.</item>\n";
  ...
  xml += "    <item>Distance V6 : profil normal echantillonne tous les 0,25 px, moyenne tangentielle sur 7 pixels, polarite imposee du bord exterieur noir, rejet adaptatif des transitions internes puis ajustement robuste des quatre droites. Largeur/hauteur sont estimees par plusieurs separations locales entre bords opposes avec moyenne robuste et incertitude par axe. La distance fusionne les deux axes selon cette incertitude. Si V6 est indisponible, le moteur conserve automatiquement le calcul precedent.</item>\n";
