...
void ApiWsdlHandler::handleRequest(AsyncWebServerRequest *request) {
  ...
  xml += "<api name=\"geometrie-camera\" version=\"31\">\n";
  ...
  xml += "    <item>V31 conserve camera V25, distance V6.1-robust5, Pose V3 et capture pipelinee; les buffers de travail V3 sont sortis de la pile FreeRTOS pour supprimer le stack overflow observe en calibration.</item>\n";
