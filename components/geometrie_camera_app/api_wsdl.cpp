...
void ApiWsdlHandler::handleRequest(AsyncWebServerRequest *request) {
  ...
  xml += "    <item>GeometryMeasurementEngine V5 fusionne z_from_width_mm et z_from_height_mm selon leur incertitude subpixel estimee ; pose_z_mm reste un controle independant issu de l homographie.</item>\n";
